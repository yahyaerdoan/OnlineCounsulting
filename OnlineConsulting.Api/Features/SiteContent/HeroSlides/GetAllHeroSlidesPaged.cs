...
using OnlineConsulting.Modules.SiteContent.Application.Features.HeroSlides.GetAllHeroSlidesPaged;
using ResultHandler.AspNetCore.Extensions;

namespace OnlineConsulting.Api.Features.SiteContent.HeroSlides;

public class GetAllHeroSlidesPaged : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        _ = app.MapPost("/api/site-content/hero-slides/query", Handle)
            .WithTags("SiteContent/HeroSlides")
            .WithName("GetAllHeroSlidesPaged")
    ...
    {
        var result = await sender.Send(new GetAllHeroSlidesPagedQuery(query.ToPageRequest(), dynamicQuery));
