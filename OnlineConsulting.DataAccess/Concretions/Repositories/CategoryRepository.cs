...
public class CategoryRepository(OnlineConsultingDbContext context) : GenericRepository<Category>(context), ICategoryRepository
{
    public IQueryable<Category> GetAllCategoriesWithImgIcons(bool traking = true, bool? status = true)
    {
