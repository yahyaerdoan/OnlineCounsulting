...
public partial class InitialCreate : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_CustomerMemberships", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_MembershipPlans", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateIndex(
            name: "IX_CustomerMemberships_TenantId_DeletedDate",
            schema: "Memberships",
            table: "CustomerMemberships",
        ...
        _ = migrationBuilder.CreateIndex(
            name: "IX_MembershipPlans_TenantId_DeletedDate",
            schema: "Memberships",
