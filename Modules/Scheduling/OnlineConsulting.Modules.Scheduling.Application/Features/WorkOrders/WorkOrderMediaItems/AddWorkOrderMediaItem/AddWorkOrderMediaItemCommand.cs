...
public class AddWorkOrderMediaItemHandler(IWorkOrderMediaItemRepository mediaItemRepository, IWorkOrderRepository workOrderRepository) : IRequestHandler<AddWorkOrderMediaItemCommand, OperationDataResult<Guid>>
{
