...
public class PayPalSubscriptionGateway(IHttpClientFactory httpClientFactory, IOptions<PaymentOptions> options) : ISubscriptionGateway
{
    ...
    /// <summary>See AddSubscriptionItemAsync/RemoveSubscriptionItemAsync - PayPal's subscription model has no concept of independently-priced additional line items.</summary>
    public bool SupportsMultipleItems => false;
