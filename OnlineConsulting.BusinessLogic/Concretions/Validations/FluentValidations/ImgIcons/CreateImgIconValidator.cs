...
namespace OnlineConsulting.BusinessLogic.Concretions.Validations.FluentValidations.ImgIcons;

internal class CreateImgIconValidator : AbstractValidator<CreateImgIconDto>
{
    public CreateImgIconValidator()
    {
        RuleFor(x => x.Name)
