...
internal class CreateContactValidator : AbstractValidator<CreateContactDto>
{
    ...
    {
        var validDomains = new[] { "gmail.com", "yahoo.com", "outlook.com", "mail.com" }; // Define valid domains
