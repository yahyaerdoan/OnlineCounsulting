...
public class OrderItemManager(IMapper mapper, IGenericRepository<OrderItem> repository) : GenericService<OrderItem, IDto>(mapper, repository), IOrderItemService
{
}
